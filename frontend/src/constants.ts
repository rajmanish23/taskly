...
export const TASK_REMOVE_TAG = (taskId: string, tagId: string) =>
  `/api/tasks/${taskId}/remove-tag/${tagId}/`;
...
export const SETTING_RESTORE_TASK_URL_WITH_PARAM =
  "/settings/restore/task/:taskId";
